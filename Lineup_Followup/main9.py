...
# CONFIGURATION
# ============================================================
input_path = r"D:\matching_harsh\Lineup_Followup\final_output\all_job_matches.xlsx\all_job_matches_duplicate.xlsx"
...
# try:
#     import subprocess
#     print("▶️ Running blasting main.py ...")
#     subprocess.run(["python", r"D:\matching_harsh\Lineup_Followup\candidate_jobs_formate\main.py"], check=True)
#     print("✅ blasting main.py executed successfully!")
# except Exception as e:
#     print(f"❌ Failed to run blasting main.py: {e}")