...
# CONFIGURATION
# =============================================================================
JOBS_FILE = r"D:\matching_harsh\Lineup_Followup\input\MASTER FILE LOCATIONS - Mapping.xlsx"
CANDIDATES_FILE = r"D:\matching_harsh\Lineup_Followup\output\output4.xlsx"
OUTPUT_DIR = r"D:\matching_harsh\Lineup_Followup\final_output\all_job_matches.xlsx"
...
try:
    ...
    subprocess.run(["python", r"D:\matching_harsh\Lineup_Followup\main8.py"], check=True)
