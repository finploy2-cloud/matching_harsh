...
# CONFIGURATION
# =====================================================
INPUT_FILE = r"D:\matching_harsh\Lineup_Followup\input\input1.xlsx"
SELECTED_FILE = "selected_designations.xlsx"
REMOVED_FILE = "removed_designations.xlsx"
OUTPUT_FILE = r"D:\matching_harsh\Lineup_Followup\output\output1.xlsx"
...
try:
    ...
    subprocess.run(["python", r"D:\matching_harsh\Lineup_Followup\main3.py"], check=True)
