...
INPUT_FILE = Path(r"D:\matching_harsh\Lineup_Followup\final_output\all_job_matches.xlsx\filtered_candidates.xlsx")
OUTPUT_DIR = Path(r"D:\matching_harsh\Lineup_Followup\candidate_jobs_formate\output")
...
try:
    ...
    subprocess.run(
        ["python", r"D:\matching_harsh\Lineup_Followup\candidate_jobs_formate\sql_insertion.py"],
        check=True
    )
