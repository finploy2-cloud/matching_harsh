...
EXCEL_PATH = Path(r"D:\matching_harsh\Job_matching_Screened\candidate_jobs_formate\output\finploy_template.xlsx")
#CSV_PATH = Path(r"D:\matching_harsh\Job_matching_Screened\candidate_jobs_formate\output\finploy_template.csv")
SQL_DB_CONFIG = {
    "host": "65.0.211.89",
...
try:
    ...
    subprocess.run(
        ["python", r"D:\matching_harsh\Job_matching_Screened\candidate_jobs_formate\blast_auto.py"],
        check=True
    )
