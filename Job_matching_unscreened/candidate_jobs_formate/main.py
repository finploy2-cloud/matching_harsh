...
INPUT_FILE = Path(r"D:\matching_harsh\Job_matching_unscreened\sumit\all_job_matches_sumit_final.xlsx")
OUTPUT_DIR = Path(r"D:\matching_harsh\Job_matching_unscreened\candidate_jobs_formate\output")
...
try:
    ...
    subprocess.run(
        ["python", r"D:\matching_harsh\Job_matching_unscreened\candidate_jobs_formate\sql_insertion.py"],
        check=True
    )
