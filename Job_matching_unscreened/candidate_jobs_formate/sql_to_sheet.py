...
class FinployLineupSync:
    def __init__(self):
        ...
        self.SERVICE_ACCOUNT_FILE = r"D:\matching_harsh\Job_matching_unscreened\candidate_jobs_formate\service_account.json"
...
try:
    ...
    subprocess.run(
        ["python", r"D:\matching_harsh\Job_matching_unscreened\candidate_jobs_formate\sql_sheet_sn.py"],
        check=True
    )
