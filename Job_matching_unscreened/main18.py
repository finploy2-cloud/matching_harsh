...
# -----------------------------------------
OUTPUT_DIR = r"D:\matching_harsh\Job_matching_unscreened\Densta_output"
...
import subprocess
try:
    print("▶️ Running main20.py ...")
    subprocess.run(["python", r"D:\matching_harsh\Job_matching_unscreened\main20.py"], check=True)
    print("✅ main20.py executed successfully!")
except Exception as e:
    print(f"❌ Failed to run main20.py: {e}")